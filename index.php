...
else
{
    ...
    $req_controller = $route[$path_split[1]];
    	//var_dump($path_split);
		/**
		 *Set Required Model name
		 *@return model;
		 */
		$req_model = $defaultModel;

		/**
		 *Set Required Method name
		 *@return method;
		 */
		$req_method = isset($path_split[3])? $path_split[3] :'';

		/**
		 *Set Required Params
		 *@return params;
		 */
		$req_param = array_slice($path_split, 4);

		/**
		 *Check if Controller Exist
		 *@return void;
		 */
		$req_controller_exists = __DIR__.'/Controllers/'.$req_controller.'.php';
		...
		if (file_exists($req_controller_exists))
		{
			 ...
			 */
			require_once __DIR__.'/Models/'.$req_model.'.php';
	    require_once __DIR__.'/Controllers/'.$req_controller.'.php';

	    	/**
			 *Model and Controller assignment with first letter as UPPERCASE
			 *@return Class;
			 */
	        $model = ucfirst($req_model);
			 ...
			 */
	        $ModelObj = new $model;
	        $ControllerObj = new $controller(ucfirst($req_model));
